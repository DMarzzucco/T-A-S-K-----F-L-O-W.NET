...
export class userControlls {
    ...
    public profile = async (req: AuthenticateRequest, res: Response) => {
    ...
    public VeryToken = async (req: AuthenticateRequest, res: Response) => {
    ...
    public putUser = async (req: AuthenticateRequest, res: Response) => {
    ...
    public deleteUser = async (req: AuthenticateRequest, res: Response) => {
    ...
    // Alles users
    public showAllUsers = async (_req: AuthenticateRequest, res: Response) => {
    ...
    public deleteAllUsers = async (_req: AuthenticateRequest, res: Response) => {
